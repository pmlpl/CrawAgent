<script setup>
// 「生态扩展」页签：MCP 服务（增删/停用/状态）+ 技能 + 插件（P2-9 生态面板归位）
// 自动启动已废除：AI 需要时会经 ask_user 询问用户，同意后才拉起服务
import { useSettings } from '../../composables/useSettings'

const { state, toggleServer, removeServer, addMcpServer, openEcoFolder } = useSettings()
