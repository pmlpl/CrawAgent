...
.srv-status.ok { color: var(--accent); border-color: color-mix(in srgb, var(--accent) 40%, transparent); background: var(--accent-soft); }
.srv-status.mid { color: var(--dim); border-color: var(--line); }
.srv-status.warn { color: #f59e0b; border-color: color-mix(in srgb, #f59e0b 40%, transparent); }
.srv-status.off { color: var(--faint); border-style: dashed; }
.mcp-add-form {
  margin-top: 10px;
  padding: 12px 14px;
