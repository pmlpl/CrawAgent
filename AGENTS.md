...
- 改动后基线：350 + ~49 pytest + 10 vitest 全绿（016 加 5 个核心工具单测 + 017 加 4 个 skills 安全单测，350 → ~399；016 已撤档详见 `/upgrade-doc` skill「诚实降级」原则；工具/设置再扩展时同步更新计数测试与 `crawagent/prompts/system.md` 工具清单 + `wiki/03-工具与技能总览.md` 的工具数）。
